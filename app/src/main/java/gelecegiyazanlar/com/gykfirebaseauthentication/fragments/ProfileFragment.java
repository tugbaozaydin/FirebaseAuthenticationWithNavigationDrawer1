...
public class ProfileFragment extends Fragment {
    ...
    TextView profileBio;
    ImageView profileUserInstagram,profileChangePhoto;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        profileChangePhoto = profileView.findViewById(R.id.change_profile_photo);

        profileChangePhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Fragment Intent yapısında bulunduğun yer için getContext kullanıyoruz.
    ...
    private void  showProfilPhoto(){
        ...
        storageReference.child("userprofilphoto").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
